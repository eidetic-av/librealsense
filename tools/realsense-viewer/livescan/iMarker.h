...
{
	int id;
	//po?o?enie naro?nik?w markera w obrazie
	std::vector<Point2f> corners;
	//te same punkty w uk?adzie wsp??rz?dnych markera
...
public:
	...
	virtual bool GetMarker(Color *img, int height, int width, MarkerInfo &marker) = 0;
};
