//   Copyright (C) 2015  Marek Kowalski (M.Kowalski@ire.pw.edu.pl), Jacek
//   Naruniec (J.Naruniec@ire.pw.edu.pl) License: MIT Software License   See
//   LICENSE.txt for the full license.

//   If you use this software in your research, then please use the following
//   citation:
...
//        title={LiveScan3D: A Fast and Inexpensive 3D Data Acquisition System
//        for Multiple Kinect v2 Sensors}, year={2015},
//    }
//
//	Original LiveScan3D code has been modified by Matthew Hughes
//	to work with realsense sdk and Windows-only types have been removed
